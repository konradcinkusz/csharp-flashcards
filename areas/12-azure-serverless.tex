...
\QuestionSlide[\CategoryBadge[MicroColor!20]{Azure SQL}]<2>{What is Azure SQL Database?}

\begin{frame}[fragile]
\frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Azure SQL}]{What is Azure SQL Database?}}
...
\QuestionSlide[\CategoryBadge[MicroColor!20]{Azure SQL}]<1>{How does Azure SQL Database work under the hood?}
...
\QuestionSlide[\CategoryBadge[MicroColor!20]{Azure SQL}]<2>{What are the key differences between Azure SQL Database and SQL Server (MSSQL)?}

\begin{frame}[fragile]
\frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Azure SQL}]{Key differences Azure SQL vs. MSSQL}}
...
\QuestionSlide[\CategoryBadge[MicroColor!20]{Azure SQL}]<1>{Can I use EF Core in Azure serverless scenarios (Azure Functions + Azure SQL Serverless)?}

\begin{frame}[fragile]
\frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Azure SQL}]{EF Core with Azure Functions \& Azure SQL Serverless}}
