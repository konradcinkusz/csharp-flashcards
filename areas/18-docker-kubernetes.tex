...
% 1 – What is Docker?
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<1>{What is Docker?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{What is Docker?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<1>{What is the difference between a Docker image and a container?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{Image vs container?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<2>{What does a multi-stage Dockerfile look like for a .NET app?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{Multi-stage Dockerfile for .NET?}}
...
% 4 – GHCR
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<1>{What is GHCR (GitHub Container Registry)?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{What is GHCR?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<1>{What are the core Kubernetes objects: Pod, Service, Deployment?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{Pod vs Service vs Deployment?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<2>{What is a Kubernetes Ingress?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{What is a Kubernetes Ingress?}}
...
% 7 – Helm
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<2>{What is Helm and why use it?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{What is Helm?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<2>{What is the difference between a Kubernetes Deployment and a StatefulSet?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{Deployment vs StatefulSet?}}
...
\QuestionSlide[\CategoryBadge[DockerColor!20]{Docker \& K8s}]<2>{What are resource requests and limits in Kubernetes?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DockerColor!20]{Docker \& K8s}]{Resource requests and limits?}}
