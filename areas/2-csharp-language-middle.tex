...
\QuestionSlide[\CategoryBadge[LangColor!20]{C\#} \CategoryBadge[CollColor!20]{Collections} \CategoryBadge[CollColor!20]{Dictionary}]<2>{What is \texttt{Dictionary<TKey, TValue>} in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{C\#} \CategoryBadge[CollColor!20]{Collections} \CategoryBadge[CollColor!20]{Dictionary}]{What is \texttt{Dictionary<TKey, TValue>} in C\#?}}
...
% 2 ── Handling keys
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{How does a dictionary handle keys in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{How does a dictionary handle keys in C\#?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What are the time and space complexities of \texttt{Dictionary<TKey, TValue>}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What are the time and space complexities of \texttt{Dictionary<TKey, TValue>}?}}
...
% 4 ── Best practices
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What are best practices when using \texttt{Dictionary<TKey, TValue>}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What are best practices when using \texttt{Dictionary<TKey, TValue>}?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What is the average time complexity of dictionary operations in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What is the average time complexity of dictionary operations in C\#?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What is the worst-case time complexity for dictionary operations?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What is the worst-case time complexity for dictionary operations?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What is a bucket list in a \texttt{Dictionary<TKey, TValue>}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What is a bucket list in a \texttt{Dictionary<TKey, TValue>}?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What is the time complexity of iterating over a dictionary?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What is the time complexity of iterating over a dictionary?}}
...
% 8 ── Space complexity
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{What is the space complexity of a dictionary in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What is the space complexity of a dictionary in C\#?}}
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<2>{How do you ensure dictionary operations stay constant-time?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{How do you ensure dictionary operations stay constant-time?}}
...
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What can you do with reflection in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What can you do with reflection in C\#?}}
...
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What is runtime reflection in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What is runtime reflection in C\#?}}
...
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What is the difference between reflection and runtime reflection?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What is the difference between reflection and runtime reflection?}}
...
% 13 ── Span<T>
\QuestionSlide[\CategoryBadge[PerfColor!20]{Performance}]<2>{What is \texttt{Span<T>}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[PerfColor!20]{Performance}]{What is \texttt{Span<T>}?}}
...
% 14 ── Code weaving
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What is code weaving in .NET?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What is code weaving in .NET?}}
...
\QuestionSlide[\CategoryBadge[ArchColor!20]{Architecture}]<2>{What are cross-cutting concerns?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[ArchColor!20]{Architecture}]{What are cross-cutting concerns?}}
...
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What are source generators?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What are source generators?}}
...
% 17 ── params keyword
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is the \texttt{params} keyword?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is the \texttt{params} keyword?}}
...
% 18 ── Iterators & yield
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are iterators and the \texttt{yield} keyword?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are iterators and the \texttt{yield} keyword?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are partial classes and methods?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are partial classes and methods?}}
...
% 20 ── Anonymous types
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are anonymous types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are anonymous types?}}
...
% 21 ── Pattern matching
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is pattern matching?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is pattern matching?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are default interface implementations?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are default interface implementations?}}
...
% 23 ── Record types
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are record types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are record types?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is value-based equality in record types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is value-based equality in record types?}}
...
% 25 ── Concise syntax
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What does concise syntax mean for record types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What does concise syntax mean for record types?}}
...
% 26 ── With-expressions
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is non-destructive mutation using \texttt{with}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is non-destructive mutation using \texttt{with}?}}
...
% 27 ── dynamic type
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is the \texttt{dynamic} type?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is the \texttt{dynamic} type?}}
...
% 28 ── Expression trees
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<2>{What are expression trees?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MetaColor!20]{Metaprogramming}]{What are expression trees?}}
...
% 29 ── ref vs out
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is the difference between \texttt{ref} and \texttt{out} keywords?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is the difference between \texttt{ref} and \texttt{out}?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{When would you use the \texttt{ref}, \texttt{out} and \texttt{in} modifiers?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{When would you use \texttt{ref}, \texttt{out}, and \texttt{in}?}}
...
% 31 ── Delegates
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are delegates?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are delegates?}}
...
% 32 ── Events
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are events?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are events?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is an anonymous method?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is an anonymous method?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are lambda expressions?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are lambda expressions?}}
...
% 35 ── Type safety
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What does type-safe mean?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What does type-safe mean?}}
...
% 36 ── Generics
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are generics?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are generics?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is exception handling in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is exception handling in C\#?}}
...
% 38 ── IDisposable
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is the \texttt{IDisposable} interface, and why implement it?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is the \texttt{IDisposable} interface, and why implement it?}}
...
% 39 ── using statement
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What is the \texttt{using} statement and \texttt{IDisposable}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What is the \texttt{using} statement and \texttt{IDisposable}?}}
...
% 40 ── Tuples
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are tuples in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are tuples in C\#?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{When to use tuples?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{When to use tuples?}}
...
% 42 ── Tuple types
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{Tuple is reference or value type?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{Tuple is reference or value type?}}
...
% 43 ── Value tuples
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are value tuples?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are value tuples?}}
...
% 44 ── Nullable types
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are nullable types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are nullable types?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are extension methods?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are extension methods?}}
...
% 46 ── Attributes
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are attributes?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are attributes?}}
...
% 47 ── Virtual methods
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are virtual methods in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are virtual methods in C\#?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{What are virtual properties in C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{What are virtual properties in C\#?}}
...
\QuestionSlide[\CategoryBadge[LangColor!20]{Language Feature}]<2>{Where are virtual properties used in C\#? (Example with EF)}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LangColor!20]{Language Feature}]{Where are virtual properties used in C\#? (Example with EF)}}
...
% 50 ── LinkedList<T>
\QuestionSlide[\CategoryBadge[LangColor!20]{C\#} \CategoryBadge[CollColor!20]{Collections} \CategoryBadge[CollColor!20]{LinkedList}]<2>{What is \texttt{LinkedList<T>} in C\# and when would you use it?}
\begin{frame}[fragile]
  \frametitle{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=north east,xshift=-0.4cm,yshift=-3.45cm] at (current page.north east) {
        \CategoryBadge[LangColor!20]{C\#} \CategoryBadge[CollColor!20]{Collections} \CategoryBadge[CollColor!20]{LinkedList}
      };
    \end{tikzpicture}
    Answer \theqcounter: What is \texttt{LinkedList<T>} in C\# and when would you use it?%
  }

  {\footnotesize
    \texttt{LinkedList<T>} is a doubly linked list providing fast insertions and removals once a node is known.
    Use it for sequences that require frequent additions or deletions at the ends or in the middle but rarely need indexed access.
  }

  \begin{minted}[fontsize=\tiny]{csharp}
public class TrainComposition
{
    LinkedList<int> cars = new();

    public void AttachLeft(int carId)  => cars.AddFirst(carId);
    public void AttachRight(int carId) => cars.AddLast(carId);

    public int DetachLeft()
    {
        int id = cars.First.Value;
        cars.RemoveFirst();
        return id;
    }
...
% 51 ── Core collection types
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]<1>{What are the primary collection types in .NET and their typical use cases?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CollColor!20]{Collections}]{What are the primary collection types in .NET and their typical use cases?}}

  {\footnotesize
    \begin{itemize}
      \item \texttt{List<T>} – dynamic array with fast index access.
      \item \texttt{LinkedList<T>} – efficient insert/remove anywhere, slow indexing.
      \item \texttt{Dictionary<TKey,TValue>} – key/value lookup.
      \item \texttt{HashSet<T>} – uniqueness without ordering.
      \item \texttt{Queue<T>} – FIFO processing.
      \item \texttt{Stack<T>} – LIFO processing.
    \end{itemize}
  }
\end{frame}
