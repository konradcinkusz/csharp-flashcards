...
% 50 ── LinkedList<T>
\QuestionSlide[\CategoryBadge[LangColor!20]{C\#} \CategoryBadge[CollColor!20]{Collections} \CategoryBadge[CollColor!20]{LinkedList}]
  {** What is \texttt{LinkedList<T>} in C\# and when would you use it?}
\begin{frame}[fragile]
  \frametitle{%
...
\QuestionSlide[\CategoryBadge[CollColor!20]{Collections}]
  {* What are the primary collection types in .NET and their typical use cases?}
\begin{frame}[fragile]
