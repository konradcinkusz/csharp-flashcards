...
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{* What is Blazor Server?}

\begin{frame}[fragile]
  \frametitle{%
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, xshift=-0.4cm, yshift=-0.4cm, text=black] at (current page.north east) {
        \CategoryBadge[BlazorColor!20]{Blazor Server}
      };
    \end{tikzpicture}
    Answer \theqcounter: What is Blazor Server?%
  }
...
% 2 – Components
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{* What is a Blazor component?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is a Blazor component?%
  }
...
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{** What is the Blazor component lifecycle?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is the Blazor component lifecycle?%
  }
...
% 4 – Data Binding
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{* What is data binding in Blazor?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is data binding in Blazor?%
  }
...
% 5 – State Management
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{** How do you manage state in Blazor Server?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: How do you manage state in Blazor Server?%
  }
...
% 6 – JS Interop
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{** What is JavaScript Interop in Blazor?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is JavaScript Interop?%
  }
...
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{** How do you handle forms and validation in Blazor?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: How do you handle forms and validation in Blazor?%
  }
...
\QuestionSlide[\CategoryBadge[BlazorColor!20]{Blazor Server}]{*** What are Blazor render modes in .NET 8?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What are Blazor render modes in .NET 8?%
  }
