% 1 ── What is C#?
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language \& Platform}]<1>{What is C\#?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language \& Platform}]{What is C\#?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language \& Platform}]<1>{What is the .NET Framework?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language \& Platform}]{What is the .NET Framework?}}
...
% 3 ── What is the CLR?
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language \& Platform}]<1>{What is the Common Language Runtime (CLR)?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language \& Platform}]{What is the Common Language Runtime (CLR)?}}
...
% 4 ── What is the CTS?
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<1>{What is the Common Type System (CTS)?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What is the Common Type System (CTS)?}}
...
% 5 ── What is the CLS?
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<1>{What is the Common Language Specification (CLS)?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What is the Common Language Specification (CLS)?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<1>{What does it mean that an object is immutable?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What does it mean that an object is immutable?}}
...
% 7 ── Stack vs Heap
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{What is stack vs heap allocation?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What is stack vs heap allocation?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{Which types go on the stack vs the heap?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{Which types go on the stack vs the heap?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{Why is stack allocation faster than heap?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{Why is stack allocation faster than heap?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{Can structs be on the heap?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{Can structs be on the heap?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{Where is a struct instance allocated—stack or heap?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{Where is a struct instance allocated—stack or heap?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{What type can be inside a struct—can struct store a class type?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What type can be inside a struct—can struct store a class type?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{What are value types and reference types?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What are value types and reference types?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{What is boxing and unboxing?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What is boxing and unboxing?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are classes and structs?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are classes and structs?}}
...
% 16 ── Interfaces
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are interfaces?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are interfaces?}}
...
% 17 ── Abstract Classes
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are abstract classes?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are abstract classes?}}
...
% 18 ── Properties
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are properties?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are properties?}}
...
% 19 ── Indexers
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are indexers?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are indexers?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are methods and method overloading?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are methods and method overloading?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Language Basics}]<2>{What are constructors and destructors?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Language Basics}]{What are constructors and destructors?}}
...
\QuestionSlide[\CategoryBadge[MemoryColor!20]{Types \& Memory}]<2>{What is garbage collection?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MemoryColor!20]{Types \& Memory}]{What is garbage collection?}}
