...
% 1 – REST Constraints
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{* What are the six REST architectural constraints?}

\begin{frame}[fragile]
  \frametitle{%
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, xshift=-0.4cm, yshift=-0.4cm, text=black] at (current page.north east) {
        \CategoryBadge[RestColor!20]{REST \& SignalR}
      };
    \end{tikzpicture}
    Answer \theqcounter: The six REST constraints?%
  }
...
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{* What HTTP verbs and status codes are standard in REST APIs?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: HTTP verbs and status codes?%
  }
...
% 3 – API Versioning
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{** What are the main strategies for REST API versioning?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: REST API versioning strategies?%
  }
...
% 4 – OpenAPI / Swagger
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{* What is OpenAPI / Swagger in ASP.NET Core?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is OpenAPI/Swagger?%
  }
...
% 5 – Problem Details
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{** What is Problem Details (RFC 7807) in ASP.NET Core?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is Problem Details?%
  }
...
% 6 – What is SignalR?
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{* What is SignalR?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is SignalR?%
  }
...
% 7 – SignalR Hubs
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{** What are SignalR Hubs?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What are SignalR Hubs?%
  }
...
\QuestionSlide[\CategoryBadge[RestColor!20]{REST \& SignalR}]{** When would you choose WebSockets vs SSE vs Long Polling?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: WebSockets vs SSE vs Long Polling?%
  }
