...
% 1 – What is an LLM?
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<1>{What is a Large Language Model (LLM)?}
...
% 2 – Tokens
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<1>{What are tokens in LLMs and why do they matter?}
...
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<2>{When do you fine-tune vs use RAG?}
...
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<2>{What is function calling / tool use in LLMs?}
...
% 5 – GitHub Copilot
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<1>{What is GitHub Copilot and how does it work?}
...
% 6 – Claude
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<1>{What is Claude and its model family?}
...
% 7 – LangChain
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<2>{What is LangChain?}
...
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<3>{What is a Multi-Agent System in the context of LLMs?}
...
\QuestionSlide[\CategoryBadge[AiToolColor!20]{AI Tools \& LLMs}]<3>{What is OpenTelemetry-based LLM observability?}
