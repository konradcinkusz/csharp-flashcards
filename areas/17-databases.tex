...
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<1>{What are the key differences between SQL Server, Oracle, and PostgreSQL?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{SQL Server vs Oracle vs PostgreSQL?}}
...
% 2 – Indexes
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What are database indexes and their key types?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What are indexes and their types?}}
...
% 3 – Execution Plan
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What is an execution plan and how do you use it?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What is an execution plan?}}
...
% 4 – CTEs
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What is a CTE (Common Table Expression)?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What is a CTE?}}
...
% 5 – Window Functions
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What are window functions in SQL?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What are window functions?}}
...
% 6 – N+1 Problem
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What is the N+1 query problem?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What is the N+1 problem?}}
...
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<2>{What are the first three normal forms in data modelling?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{What are the first three normal forms?}}
...
\QuestionSlide[\CategoryBadge[DbColor!20]{Databases}]<3>{What are the most impactful SQL query optimisation techniques?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[DbColor!20]{Databases}]{Key query optimisation techniques?}}
