...
% 2 ── .Select() in LINQ
\QuestionSlide[\CategoryBadge[LinqColor!20]{LINQ}]<1>{What does \texttt{.Select()} do in LINQ?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LinqColor!20]{LINQ}]{What does \texttt{.Select()} do in LINQ?}}
  {\footnotesize
...
\QuestionSlide[\CategoryBadge[LinqColor!20]{LINQ}]<2>{What does \texttt{.SelectMany()} do in LINQ?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LinqColor!20]{LINQ}]{What does \texttt{.SelectMany()} do in LINQ?}}
  {\footnotesize
...
\QuestionSlide[\CategoryBadge[LinqColor!20]{LINQ}]<2>{When would you use \texttt{.SelectMany()} instead of \texttt{.Select()}?}
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[LinqColor!20]{LINQ}]{When would you use \texttt{.SelectMany()} instead of \texttt{.Select()}?}}
  {\footnotesize
