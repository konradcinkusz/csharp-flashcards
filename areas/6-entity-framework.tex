...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What is \textbf{lazy loading} in Entity Framework and how can you disable it?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is \textbf{lazy loading} in Entity Framework and how can you disable it?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What main risk does lazy loading introduce?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What main risk does lazy loading introduce?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<1>{How do you enable eager loading?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{How do you enable eager loading?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{Give one advantage of eager loading over lazy loading.}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{Give one advantage of eager loading over lazy loading.}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<1>{When might lazy loading be preferred?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{When might lazy loading be preferred?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What is \texttt{SplitQuery} vs \texttt{SingleQuery} in eager loading?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is \texttt{SplitQuery} vs \texttt{SingleQuery} in eager loading?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{When might \texttt{TemporalAsOf} be preferred?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{When might \texttt{TemporalAsOf} be preferred?}}
