...
% 1 – Azure App Service
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<1>{What is Azure App Service?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Azure App Service?}}
...
% 2 – Managed Identity
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<2>{What is Azure Managed Identity?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Managed Identity?}}
...
% 3 – Azure Key Vault
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<1>{What is Azure Key Vault?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Azure Key Vault?}}
...
% 4 – Azure AI Foundry
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<2>{What is Azure AI Foundry?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Azure AI Foundry?}}
...
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<2>{What is Azure AI Foundry Prompt Flow?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Prompt Flow?}}
...
% 6 – Azure Service Bus
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<2>{What is Azure Service Bus and when do you use it?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Azure Service Bus?}}
...
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<1>{What are essential Azure CLI patterns for .NET developers?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{Essential Azure CLI patterns?}}
...
\QuestionSlide[\CategoryBadge[AzureColor!20]{Azure}]<2>{What is Application Insights and how do you add it to an ASP.NET Core app?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[AzureColor!20]{Azure}]{What is Application Insights?}}
