...
% 1 – What is CI/CD?
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<1>{What is CI/CD?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What is CI/CD?}}
...
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What is an Azure DevOps YAML Pipeline?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What is an Azure DevOps YAML Pipeline?}}
...
% 3 – GitHub Actions
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What is a GitHub Actions workflow?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What is a GitHub Actions workflow?}}
...
% 4 – Terraform
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What is Terraform?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What is Terraform?}}
...
% 5 – Terraform State
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What is Terraform state and why does it need remote storage?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What is Terraform state?}}
...
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What is the difference between Blue-Green and Canary deployments?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{Blue-Green vs Canary deployments?}}
...
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<2>{What are environment protection rules in GitHub Actions / Azure DevOps?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What are environment protection rules?}}
...
\QuestionSlide[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]<1>{What are Azure DevOps Artifacts?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[CICDColor!20]{CI/CD \& IaC}]{What are Azure DevOps Artifacts?}}
