...
% 2 ── Span<T>
\QuestionSlide[\CategoryBadge[PerfColor!20]{Performance}]<3>{What is \texttt{Span<T>}?}
\begin{frame}[fragile]
...
% 5 ── Source generators
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<3>{What are source generators?}
\begin{frame}[fragile]
...
% 6 ── Expression trees
\QuestionSlide[\CategoryBadge[MetaColor!20]{Metaprogramming}]<3>{What are expression trees?}
\begin{frame}[fragile]
