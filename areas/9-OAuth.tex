\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is OAuth 2.0 in the context of .NET/C\#?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is OAuth 2.0 in the context of .NET/C\#?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<1>{What are the main roles in OAuth 2.0?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{Main Roles in OAuth 2.0}}
...
% PKCE
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is PKCE and why is it used?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is PKCE and why is it used?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is the Authorization Code Flow?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is the Authorization Code Flow?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{Authorization Code Flow — Step 1}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{Step 1}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{Authorization Code Flow — Step 2}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{Step 2}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{Authorization Code Flow — Step 3}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{Step 3}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{Authorization Code Flow — Step 4}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{Step 4}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{Authorization Code Flow Diagram}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is the Client Credentials Flow?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is the Client Credentials Flow?}}
...
% Scopes
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What are scopes in OAuth 2.0?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What are scopes in OAuth 2.0?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{How do you configure JWT Bearer Authentication in ASP\.NET Core?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{How do you configure JWT Bearer Authentication in ASP\.NET Core?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is OpenID Connect?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is OpenID Connect?}}
...
% ID Token
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is an ID Token?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is an ID Token?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{How do you implement OpenID Connect in ASP\.NET Core?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{How do you implement OpenID Connect in ASP\.NET Core?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is the difference between OAuth 2.0 and OpenID Connect?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is the difference between OAuth 2.0 and OpenID Connect?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is ASP\.NET Core Identity?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is ASP\.NET Core Identity?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is Cookie Authentication in ASP\.NET Core?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is Cookie Authentication in ASP\.NET Core?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is Claims-based Authorization?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is Claims-based Authorization?}}
...
% 4 ── Roles vs Policies
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is the difference between Roles and Policies?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is the difference between Roles and Policies?}}
...
\QuestionSlide[\CategoryBadge[AuthColor!20]{Security}]<2>{What is a Refresh Token and how is it used?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[AuthColor!20]{Security}]{What is a Refresh Token and how is it used?}}
