...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<1>{What is dependency injection in .NET?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{What is dependency injection in .NET?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<3>{What design pattern should be used for exception handling?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{What design pattern should be used for exception handling?}}
...
\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{Exception handling design pattern example}}
...
% 4 ── CQRS pattern
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<1>{What is the CQRS pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{What is CQRS?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<1>{What is Command–Query Separation (CQS)?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{What is CQS?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<3>{What is the Value Object Pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{What is the Value Object Pattern?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<3>{Why should Value Objects be immutable?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{Why should Value Objects be immutable?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<3>{How do you compare Value Objects in C\#?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{How do you compare Value Objects in C\#?}}
...
\QuestionSlide[\CategoryBadge[OOPColor!20]{Design Patterns}]<3>{When should you use the Value Object Pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{Design Patterns}]{When should you use the Value Object Pattern?}}
