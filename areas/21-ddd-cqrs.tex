...
% 1 – What is DDD?
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{* What is Domain-Driven Design (DDD)?}

\begin{frame}[fragile]
  \frametitle{%
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, xshift=-0.4cm, yshift=-0.4cm, text=black] at (current page.north east) {
        \CategoryBadge[DDDColor!20]{DDD \& CQRS}
      };
    \end{tikzpicture}
    Answer \theqcounter: What is Domain-Driven Design?%
  }
...
% 2 – Bounded Context
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{** What is a Bounded Context in DDD?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is a Bounded Context?%
  }
...
% 3 – Aggregate
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{** What is an Aggregate in DDD?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is an Aggregate?%
  }
...
% 4 – Value Object
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{* What is a Value Object in DDD?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is a Value Object?%
  }
...
% 5 – Domain Events
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{** What are Domain Events?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What are Domain Events?%
  }
...
% 6 – CQRS
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{** What is CQRS?}
...
% 7 – MediatR
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{** What is MediatR and how does it support CQRS in .NET?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is MediatR?%
  }
...
% 8 – Event Sourcing
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{*** What is Event Sourcing?}
...
\QuestionSlide[\CategoryBadge[DDDColor!20]{DDD \& CQRS}]{*** What is the Saga pattern in distributed systems?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is the Saga pattern?%
  }
