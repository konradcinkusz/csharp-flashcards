...
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<1>{What is ASP.NET Core?}
...
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What is the ASP.NET Core middleware pipeline?}
...
% 3 – DI Lifetimes
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What are the three DI service lifetimes in ASP.NET Core?}
...
% 4 – Minimal APIs
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What are Minimal APIs in ASP.NET Core?}
...
% 5 – Action Filters
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What are Action Filters in ASP.NET Core MVC?}
...
% 6 – Output Caching
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What is Output Caching in ASP.NET Core 7+?}
...
% 7 – Health Checks
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<2>{What are Health Checks in ASP.NET Core?}
...
% 8 – Options Pattern
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<1>{What is the Options pattern in ASP.NET Core?}
...
% 9 – Rate Limiting
\QuestionSlide[\CategoryBadge[AspNetColor!20]{ASP.NET Core}]<3>{What is Rate Limiting middleware in ASP.NET Core 7+?}
