...
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{* What is .NET Aspire?}

\begin{frame}[fragile]
  \frametitle{%
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, xshift=-0.4cm, yshift=-0.4cm, text=black] at (current page.north east) {
        \CategoryBadge[AspireColor!20]{.NET Aspire}
      };
    \end{tikzpicture}
    Answer \theqcounter: What is .NET Aspire?%
  }
...
% 2 – App Host
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{** What is the .NET Aspire App Host?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is the Aspire App Host?%
  }
...
% 3 – Service Discovery
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{** What is Service Discovery in .NET Aspire?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is Service Discovery in .NET Aspire?%
  }
...
% 4 – Dashboard
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{* What does the .NET Aspire Dashboard show?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What does the Aspire Dashboard show?%
  }
...
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{** What are .NET Aspire Integrations?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What are .NET Aspire Integrations?%
  }
...
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{** What does WaitFor do in .NET Aspire?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What does WaitFor do in .NET Aspire?%
  }
...
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{*** What is the Aspire Manifest and how is it used for deployment?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is the Aspire Manifest?%
  }
...
\QuestionSlide[\CategoryBadge[AspireColor!20]{.NET Aspire}]{** How does .NET Aspire differ from docker-compose?}
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: Aspire vs docker-compose?%
  }
