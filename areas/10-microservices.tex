...
% 1 – Bulkhead Pattern
\QuestionSlide[\CategoryBadge[MicroColor!20]{Microservices}]<2>{What is the Bulkhead Pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Microservices}]{What is the Bulkhead Pattern?}}
...
% 2 – Sidecar Pattern
\QuestionSlide[\CategoryBadge[MicroColor!20]{Microservices}]<1>{What is the Sidecar Pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Microservices}]{What is the Sidecar Pattern?}}
...
% 3 – Service Mesh
\QuestionSlide[\CategoryBadge[MicroColor!20]{Microservices}]<2>{What is a Service Mesh?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Microservices}]{What is a Service Mesh?}}
...
\QuestionSlide[\CategoryBadge[MicroColor!20]{Microservices}]<1>{What is the Strangler Fig Pattern?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Microservices}]{What is the Strangler Fig Pattern?}}
...
% 5 – Event Sourcing
\QuestionSlide[\CategoryBadge[MicroColor!20]{Microservices}]<2>{What is Event Sourcing?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[MicroColor!20]{Microservices}]{What is Event Sourcing?}}
