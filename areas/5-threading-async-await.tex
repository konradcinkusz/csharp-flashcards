% 1 ── What is a thread?
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What is a thread?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is a thread?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What is the difference between synchronous and asynchronous code?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is the difference between synchronous and asynchronous code?}}
...
% 3 ── Task basics
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What is a \texttt{Task}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is a \texttt{Task}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What does the \texttt{async} keyword do?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What does the \texttt{async} keyword do?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What does the \texttt{await} keyword do?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What does the \texttt{await} keyword do?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What happens if you forget to \texttt{await} an async method?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What happens if you forget to \texttt{await} an async method?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{Does async always make code faster?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{Does async always make code faster?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{Why use async in console, desktop, and web apps?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{Why use async in console, desktop, and web apps?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What's the difference between async and multithreading?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What's the difference between async and multithreading?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What is the .NET Thread Pool?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is the .NET Thread Pool?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{What's the difference between \texttt{Task.Run} and \texttt{Thread}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What's the difference between \texttt{Task.Run} and \texttt{Thread}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{When should you use \texttt{Task.Run}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{When should you use \texttt{Task.Run}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<2>{Which is faster: a synchronous or asynchronous endpoint? Why?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{Which is faster: a synchronous or asynchronous endpoint? Why?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{How can synchronous code calling asynchronous methods cause deadlocks?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{How can synchronous code calling asynchronous methods cause deadlocks?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{How do exceptions flow in async methods?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{How do exceptions flow in async methods?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{Why is \texttt{async void} usually a bad idea?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{Why is \texttt{async void} usually a bad idea?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{When and why should you use \texttt{ConfigureAwait(false)} in async methods?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{When and why should you use \texttt{ConfigureAwait(false)} in async methods?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What's the difference between \texttt{Parallel.ForEach()} and \texttt{Task.WhenAll()}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What's the difference between \texttt{Parallel.ForEach()} and \texttt{Task.WhenAll()}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{How do you correctly implement cancellation in asynchronous methods?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{How do you correctly implement cancellation in asynchronous methods?}}
...
% 20 ── Async streams
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What are async streams (\texttt{IAsyncEnumerable<T>})?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What are async streams (\texttt{IAsyncEnumerable<T>})?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What's the difference between returning \texttt{IAsyncEnumerable<T>} and \texttt{Task<IEnumerable<T>>}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What's the difference between returning \texttt{IAsyncEnumerable<T>} and \texttt{Task<IEnumerable<T>>}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What's the difference between \texttt{Task} and \texttt{ValueTask}?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What's the difference between \texttt{Task} and \texttt{ValueTask}?}}
...
\QuestionSlide[\CategoryBadge[PerfColor!20]{Async \& Threading}]<3>{What is the \texttt{SynchronizationContext} and why does it matter?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{C\#} \CategoryBadge[PerfColor!20]{Async \& Threading}]{What is the \texttt{SynchronizationContext} and why does it matter?}}
