...
\QuestionSlide[\CategoryBadge[OOPColor!20]{OOP}]<1>{What are the core object-oriented programming (OOP) paradigms?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{OOP}]{What are the core object-oriented programming (OOP) paradigms?}}
...
% 2 ── Inheritance in C#
\QuestionSlide[\CategoryBadge[OOPColor!20]{OOP}]<1>{What is inheritance in C\#?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{OOP}]{What is inheritance in C\#?}}
...
% 3 ── Polymorphism
\QuestionSlide[\CategoryBadge[OOPColor!20]{OOP}]<1>{What is polymorphism?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{OOP}]{What is polymorphism?}}
...
% 4 ── Encapsulation
\QuestionSlide[\CategoryBadge[OOPColor!20]{OOP}]<1>{What is encapsulation?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{OOP}]{What is encapsulation?}}
...
% 5 ── Loose coupling
\QuestionSlide[\CategoryBadge[OOPColor!20]{OOP}]<2>{What is loose coupling?}

\begin{frame}[fragile]
  \frametitle{\AnswerTitle[\CategoryBadge[OOPColor!20]{OOP}]{What is loose coupling?}}
