  ...
  \frametitle{%
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east, xshift=-0.4cm, yshift=-0.4cm, text=black] at (current page.north east) {
        \CategoryBadge[ToolingColor!20]{Tooling \& Agile}
      };
    \end{tikzpicture}
    Answer \theqcounter: Core Git concepts?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: GitFlow vs Trunk-Based Development?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is Azure DevOps Boards?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: Jira vs Azure DevOps Boards?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is Scrum?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is Power BI?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is the Definition of Done?%
  }
...
\begin{frame}[fragile]
  \frametitle{%
    ...
    \end{tikzpicture}
    Answer \theqcounter: What is LaTeX?%
  }
