...
% 1 – Git Core Concepts
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What are the core Git concepts every developer must know?}
...
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<2>{What are GitFlow and Trunk-Based Development?}
...
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What is Azure DevOps Boards?}
...
% 4 – Jira
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What is Jira and when would you choose it over Azure DevOps Boards?}
...
% 5 – Agile / Scrum
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What is Scrum and its key ceremonies?}
...
% 6 – Power BI
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What is Power BI?}
...
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<2>{What is the Definition of Done (DoD) in Scrum?}
...
% 8 – LaTeX
\QuestionSlide[\CategoryBadge[ToolingColor!20]{Tooling \& Agile}]<1>{What is LaTeX and when should a developer use it?}
